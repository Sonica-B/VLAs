#!/bin/bash
# =============================================================================
# Single-model probe: Idefics2-8B (Aug 2024)
# =============================================================================
# SigLIP-SO400M + perceiver resampler (64 q tokens) + Mistral 7B.
# Compression ~11.4x. Mid-compression panel-filler for the LOO regression.
# Apache-2.0. arxiv 2405.02246.
#
#     sbatch turing/16_probe_idefics2.sh
# =============================================================================

#SBATCH -J probe-idefics2
#SBATCH -p quick
#SBATCH -N 1
#SBATCH -n 4
#SBATCH --mem=48G
...
if dt > 500:
    print(f"FATAL: GPU op took {dt:.0f}ms (expected <100ms)", file=sys.stderr); sys.exit(2)
PYCHECK
